...
site[0] = {
    title:'スポーツナビ＋',
    url:'http://entry.plus-blog.sportsnavi.com/feed/articles_ranking/rss2_0.xml',
    disp_entry:4        // 取得する記事の数
};

site[1] = {
    title:'Number Web',
    url:'http://rss.rssad.jp/rss/number/rsscolumn',
    disp_entry:4        // 取得する記事の数
};
...
site[3] = {
    title:'ライブドアニュース',
    url:'http://news.livedoor.com/rss/article/vender/hochi',
    disp_entry:4        // 取得する記事の数
};

site[4] = {
    title:'２ｃｈスポーツニュースナビ',
    url:'http://2chsportsnavi.blog.fc2.com/?xml',
    disp_entry:4        // 取得する記事の数
};
