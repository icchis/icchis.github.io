...
site[0] = {
    title:'NAVER',
    url:'http://matome.naver.jp/feed/humor',
    disp_entry:4        // 取得する記事の数
};

site[1] = {
    title:'面白ネタまとめ',
    url:'http://omosiro-neta.net/?xml',
    disp_entry:4        // 取得する記事の数
};

site[2] = {
    title:'勝つるあんてな！',
    url:'http://katuru.com/rss',
    disp_entry:4        // 取得する記事の数
};

site[3] = {
    title:'ニーてつVIPブログ',
    url:'http://neetetsu.com/index.rdf',
    disp_entry:4        // 取得する記事の数
};
...
site[4] = {
    ...
    disp_entry:4        // 取得する記事の数
};http://huyosoku.com/feed

site[5] = {
    title:'ふよふよ速報。',
    url:'http://huyosoku.com/feed',
    disp_entry:4        // 取得する記事の数
};
