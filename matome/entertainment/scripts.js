...
site[1] = {
    title:'スクープ！エンタメ 芸能 のツボ',
    url:'http://entamegeinounotubo.seesaa.net/index20.rdf',
    disp_entry:4        // 取得する記事の数
};

site[2] = {
    title:'芸能アンテナ',
    url:'http://kimuchi.antenam.info/rss1s.rss',
    disp_entry:4        // 取得する記事の数
};

site[3] = {
    title:'芸能7days',
    url:'http://geinou-7days.seesaa.net/index.rdf',
    disp_entry:4        // 取得する記事の数
};

site[4] = {
    title:'芸能人やじうまニュース',
    url:'http://entame-geinou.com/feed/',
    disp_entry:4        // 取得する記事の数
};

site[5] = {
    title:'エンタメ スクープ',
    url:'http://rss.rssad.jp/rss/oQBbsYldNaoh/rss_0001',
    disp_entry:4        // 取得する記事の数
};
